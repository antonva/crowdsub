...
namespace CrowdSub.Controllers
{
    public class SubtitleController : Controller
    {
		...
		[HttpPost]
		public ActionResult search_for_title_or_user()
		{
			return RedirectToAction("search_for_title_or_user");
		}
		...
		[HttpGet]
		public ActionResult request_subtitle(int? video_id)
		{
			return View();
		}

		[HttpPost]
		public ActionResult request_subtitle(string version) //nullable id
		{
			//get video from video table, send title to view as a string
			//maybe show poster?
			...
			return RedirectToAction("video_profile");
		}
