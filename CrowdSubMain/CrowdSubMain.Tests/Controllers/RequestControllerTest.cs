...
using CrowdSubMain.Tests.Mocks;   //Bætt við
using CrowdSubMain.Models;   //Bætt við
using System.Web.Mvc;  //Bætt við
using CrowdSubMain.Controllers;  //Bætt við
using CrowdSubMain;   //Bætt við
using System.Collections.Generic;  //Bætt við
using System.Linq; //Bætt við
using System.Text;  //Bætt við
